...
class Visitante(models.Model):
    ...
    # Campo antigo (mantido para compatibilidade, mas agora usamos o link com Morador)
    ...
    # --- CAMPO NOVO QUE FALTAVA (CORREÇÃO DO ERRO) ---
...
class Encomenda(models.Model):
    ...
    # Novo campo para encomendas de terceiros/amigos
